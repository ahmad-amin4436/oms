                      ...
                      <div class="position-relative z-2">
                        ...
                        <div class="d-flex py-3">
                          ...
                          <div class="ps-3">
                            ...
                            <h4 class="text-800 mb-0">Rs. 21,349.29 </h4>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="card h-md-100 ecommerce-card-min-width">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end">
                          <div class="row">
                            <div class="col">
                              <p class="font-sans-serif lh-1 mb-1 fs-2">Rs. 47K</p><span class="badge badge-subtle-success rounded-pill fs--2">+3.5%</span>
                            </div>
                ...
                <div class="card-body py-3">
                  <div class="row g-0">
                    ...
                    <div class="col-6 col-md-4 border-200 border-bottom border-end border-end-md-0 pb-4 pt-4 pt-md-0 ps-md-3">
                      ...
                      <p class="font-sans-serif lh-1 mb-1 fs-2">Rs. 145.65 </p>
                      <div class="d-flex align-items-center">
                        <h6 class="fs--1 text-500 mb-0">13,675 </h6>
                    ...
                    <div class="col-6 col-md-4 border-200 border-bottom border-bottom-md-0 border-end-md pt-4 pb-md-0 ps-3 ps-md-0">
                      ...
                      <p class="font-sans-serif lh-1 mb-1 fs-2">Rs. 100.26 </p>
                      <div class="d-flex align-items-center">
                        <h6 class="fs--1 text-500 mb-0">Rs. 109.65 </h6>
                    ...
                    <div class="col-6 col-md-4 border-200 border-bottom-md-0 border-end pt-4 pb-md-0 ps-md-3">
                      ...
                      <p class="font-sans-serif lh-1 mb-1 fs-2">Rs. 365.53 </p>
                      <div class="d-flex align-items-center">
                        <h6 class="fs--1 text-500 mb-0">13,675 </h6>
                        <h6 class="fs--2 ps-3 mb-0 text-success"><span class="me-1 fas fa-caret-up"></span>21.8%</h6>
                      </div>
                ...
                <div class="card-header">
                  <div class="row flex-between-center g-0">
                    ...
                    <div class="col-auto d-flex">
                      <div class="form-check mb-0 d-flex"><input class="form-check-input form-check-input-primary" id="ecommerceLastMonth" type="checkbox" checked="checked" /><label class="form-check-label ps-2 fs--2 text-600 mb-0" for="ecommerceLastMonth">Last Month<span class="text-dark d-none d-md-inline">: Rs. 32,502.00</span></label></div>
                      <div class="form-check mb-0 d-flex ps-0 ps-md-3"><input class="form-check-input ms-2 form-check-input-warning opacity-75" id="ecommercePrevYear" type="checkbox" checked="checked" /><label class="form-check-label ps-2 fs--2 text-600 mb-0" for="ecommercePrevYear">Prev Year<span class="text-dark d-none d-md-inline">: Rs. 46,018.00</span></label></div>
                    </div>
                    <div class="col-auto">
                    ...
                    <table class="table table-sm fs--1 mb-0 overflow-hidden">
                      ...
                      <tbody class="list" id="table-purchase-body">
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-end amount">Rs. 99</td>
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 634</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-end amount">Rs. 199</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 798</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-secondary">Blocked<span class="ms-1 fas fa-ban" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 318</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-end amount">Rs. 11</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 31</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 43</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 57</td>
                          <td class="align-middle white-space-nowrap text-end">
                        ...
                        <tr class="btn-reveal-trigger">
                          ...
                          <td class="align-middle white-space-nowrap product">Apple iPhone XR (64GB)</td>
                          <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-secondary">Blocked<span class="ms-1 fas fa-ban" data-fa-transform="shrink-2"></span></span></td>
                          <td class="align-middle text-end amount">Rs. 999</td>
                          <td class="align-middle white-space-nowrap text-end">
                    ...
                    <table class="table table-dashboard mb-0 table-borderless fs--1 border-200">
                      ...
                      <tbody>
                        <tr class="border-bottom border-200">
                          ...
                          <td class="align-middle text-end fw-semi-bold">Rs. 1311</td>
                        ...
                        <tr class="border-bottom border-200">
                          ...
                          <td class="align-middle text-end fw-semi-bold">Rs. 539</td>
                          <td class="align-middle pe-x1">
                            <div class="d-flex align-items-center">
                        ...
                        <tr class="border-bottom border-200">
                          ...
                          <td class="align-middle text-end fw-semi-bold">Rs. 245</td>
                          <td class="align-middle pe-x1">
                            <div class="d-flex align-items-center">
                        ...
                        <tr class="border-bottom border-200">
                          ...
                          <td class="align-middle text-end fw-semi-bold">Rs. 234</td>
                          <td class="align-middle pe-x1">
                            <div class="d-flex align-items-center">
