...
var echartsAreaPiecesChartInit = function echartsAreaPiecesChartInit() {
  var Rs. areaPiecesChartEl = document.querySelector('.echart-area-pieces-chart-example');

  if (Rs. areaPiecesChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. areaPiecesChartEl, 'options');
    var chart = window.echarts.init(Rs. areaPiecesChartEl);
...
var echartsBarLineChartInit = function echartsBarLineChartInit() {
  var Rs. barLineChartEl = document.querySelector('.echart-bar-line-chart-example');

  if (Rs. barLineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barLineChartEl, 'options');
    var chart = window.echarts.init(Rs. barLineChartEl);
...
var echartsBarNegativeChartInit = function echartsBarNegativeChartInit() {
  var Rs. barNegativeChartEl = document.querySelector('.echart-bar-chart-negative-example');

  if (Rs. barNegativeChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barNegativeChartEl, 'options');
    var chart = window.echarts.init(Rs. barNegativeChartEl);
...
var echartsBarRaceChartInit = function echartsBarRaceChartInit() {
  var Rs. barRaceChartEl = document.querySelector('.echart-bar-race-chart-example');

  if (Rs. barRaceChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barRaceChartEl, 'options');
    var chart = window.echarts.init(Rs. barRaceChartEl);
...
var echartsBarSeriesChartInit = function echartsBarSeriesChartInit() {
  var Rs. barSeriesChartEl = document.querySelector('.echart-bar-chart-series-example');

  if (Rs. barSeriesChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barSeriesChartEl, 'options');
    var chart = window.echarts.init(Rs. barSeriesChartEl);
...
var echartsBarStackedChartInit = function echartsBarStackedChartInit() {
  var Rs. barStackedChartEl = document.querySelector('.echart-bar-stacked-chart-example');

  if (Rs. barStackedChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barStackedChartEl, 'options');
    var chart = window.echarts.init(Rs. barStackedChartEl);
    var xAxisData = [];
    var _data = [];
    var _data2 = [];
    var data3 = [];
...
var echartsBarTimelineChartInit = function echartsBarTimelineChartInit() {
  var Rs. barTimelineChartEl = document.querySelector('.echart-bar-timeline-chart-example');

  if (Rs. barTimelineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barTimelineChartEl, 'options');
    var chart = window.echarts.init(Rs. barTimelineChartEl);
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    var dataMap = {};
...
var echartsWaterFallChartInit = function echartsWaterFallChartInit() {
  var Rs. waterfallChartEl = document.querySelector('.echart-nightfall-chart-example');

  if (Rs. waterfallChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. waterfallChartEl, 'options');
    var chart = window.echarts.init(Rs. waterfallChartEl);
...
var echartsBasicBarChartInit = function echartsBasicBarChartInit() {
  var Rs. barChartEl = document.querySelector('.echart-basic-bar-chart-example');

  if (Rs. barChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. barChartEl, 'options');
    var chart = window.echarts.init(Rs. barChartEl);
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
...
var echartsBasicCandlestickChartInit = function echartsBasicCandlestickChartInit() {
  var Rs. basicCandleStickChartEl = document.querySelector('.echart-candlestick-chart-example');

  if (Rs. basicCandleStickChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. basicCandleStickChartEl, 'options');
    var chart = window.echarts.init(Rs. basicCandleStickChartEl);
...
var echartsBasicGaugeChartInit = function echartsBasicGaugeChartInit() {
  var Rs. basicGaugeChartEl = document.querySelector('.echart-basic-gauge-chart-example');

  if (Rs. basicGaugeChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. basicGaugeChartEl, 'options');
    var chart = window.echarts.init(Rs. basicGaugeChartEl);
...
var echartsLineChartInit = function echartsLineChartInit() {
  var Rs. lineChartEl = document.querySelector('.echart-line-chart-example');

  if (Rs. lineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineChartEl, 'options');
    var chart = window.echarts.init(Rs. lineChartEl);
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    var data = [1272, 1301, 1402, 1216, 1086, 1236, 1219, 1330, 1367, 1416, 1297, 1204];
...
var echartsBubbleChartInit = function echartsBubbleChartInit() {
  var Rs. bubbleChartEl = document.querySelector('.echart-bubble-chart-example');

  if (Rs. bubbleChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. bubbleChartEl, 'options');
    var chart = window.echarts.init(Rs. bubbleChartEl);
...
var echartsCandlestickMixedChartInit = function echartsCandlestickMixedChartInit() {
  var Rs. candleStickMixedChartEl = document.querySelector('.echart-candlestick-mixed-chart-example');

  if (Rs. candleStickMixedChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. candleStickMixedChartEl, 'options');
    var chart = window.echarts.init(Rs. candleStickMixedChartEl);
...
var echartsDoughnutChartInit = function echartsDoughnutChartInit() {
  var Rs. doughnutChartEl = document.querySelector('.echart-doughnut-chart-example');

  if (Rs. doughnutChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. doughnutChartEl, 'options');
    var chart = window.echarts.init(Rs. doughnutChartEl);
...
var echartsDoughnutRoundedChartInit = function echartsDoughnutRoundedChartInit() {
  var Rs. doughnutRoundedChartEl = document.querySelector('.echart-doughnut-rounded-chart');

  if (Rs. doughnutRoundedChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. doughnutRoundedChartEl, 'options');
    var chart = window.echarts.init(Rs. doughnutRoundedChartEl);
...
var echartsDynamicLineChartInit = function echartsDynamicLineChartInit() {
  var Rs. dynamicLineChartEl = document.querySelector('.echart-dynamic-line-chart-example');

  if (Rs. dynamicLineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. dynamicLineChartEl, 'options');
    var chart = window.echarts.init(Rs. dynamicLineChartEl);
...
var echartsGaugeGradeChartInit = function echartsGaugeGradeChartInit() {
  var Rs. gaugeGradeChartEl = document.querySelector('.echart-gauge-grade-chart-example');

  if (Rs. gaugeGradeChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gaugeGradeChartEl, 'options');
    var chart = window.echarts.init(Rs. gaugeGradeChartEl);
...
var echartsGaugeMultiRingChartInit = function echartsGaugeMultiRingChartInit() {
  var Rs. gaugeMultiRingChartEl = document.querySelector('.echart-gauge-multi-ring-chart-example');

  if (Rs. gaugeMultiRingChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gaugeMultiRingChartEl, 'options');
    var chart = window.echarts.init(Rs. gaugeMultiRingChartEl);
...
var echartsGaugeMultiTitleChartInit = function echartsGaugeMultiTitleChartInit() {
  var Rs. gaugeMultiTitleChartEl = document.querySelector('.echart-gauge-multi-title-chart-example');

  if (Rs. gaugeMultiTitleChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gaugeMultiTitleChartEl, 'options');
    var chart = window.echarts.init(Rs. gaugeMultiTitleChartEl);
...
var echartsGaugeProgressChartInit = function echartsGaugeProgressChartInit() {
  var Rs. gaugeProgressChartEl = document.querySelector('.echart-gauge-progress-chart-example');

  if (Rs. gaugeProgressChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gaugeProgressChartEl, 'options');
    var chart = window.echarts.init(Rs. gaugeProgressChartEl);
...
var echartsGaugeRingChartInit = function echartsGaugeRingChartInit() {
  var Rs. gaugeRingChartEl = document.querySelector('.echart-gauge-ring-chart-example');

  if (Rs. gaugeRingChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gaugeRingChartEl, 'options');
    var chart = window.echarts.init(Rs. gaugeRingChartEl);
...
var echartsGradientBarChartInit = function echartsGradientBarChartInit() {
  var Rs. gradientBarChartEl = document.querySelector('.echart-gradient-bar-chart-example');

  if (Rs. gradientBarChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. gradientBarChartEl, 'options');
    var chart = window.echarts.init(Rs. gradientBarChartEl);
...
var echartsHeatMapChartInit = function echartsHeatMapChartInit() {
  ...
  var Rs. echartHeatmapChart = document.querySelector(ECHART_HEATMAP_CHART);
  ...
  if (Rs. echartHeatmapChart) {
    var userOptions = utils.getData(Rs. echartHeatmapChart, 'options');
    var chart = window.echarts.init(Rs. echartHeatmapChart);
...
var echartsHorizontalBarChartInit = function echartsHorizontalBarChartInit() {
  var Rs. horizontalBarChartEl = document.querySelector('.echart-horizontal-bar-chart-example');

  if (Rs. horizontalBarChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. horizontalBarChartEl, 'options');
    var chart = window.echarts.init(Rs. horizontalBarChartEl);
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    var data = [1272, 1301, 1402, 1216, 1086, 1236, 1219, 1330, 1367, 1416, 1297, 1204];
...
var echartsLineAreaChartInit = function echartsLineAreaChartInit() {
  var Rs. lineAreaChartEl = document.querySelector('.echart-line-area-chart-example');

  if (Rs. lineAreaChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineAreaChartEl, 'options');
    var chart = window.echarts.init(Rs. lineAreaChartEl);
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
...
var echartsLineGradientChartInit = function echartsLineGradientChartInit() {
  var Rs. lineGradientChartEl = document.querySelector('.echart-line-gradient-chart-example');

  if (Rs. lineGradientChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineGradientChartEl, 'options');
    var chart = window.echarts.init(Rs. lineGradientChartEl);
...
var echartsLineLogChartInit = function echartsLineLogChartInit() {
  var Rs. lineLogChartEl = document.querySelector('.echart-line-log-chart-example');

  if (Rs. lineLogChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineLogChartEl, 'options');
    var chart = window.echarts.init(Rs. lineLogChartEl);
...
var echartsLineMarkerChartInit = function echartsLineMarkerChartInit() {
  var Rs. lineMarkerChartEl = document.querySelector('.echart-line-marker-chart-example');

  if (Rs. lineMarkerChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineMarkerChartEl, 'options');
    var chart = window.echarts.init(Rs. lineMarkerChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
...
var echartsLineRaceChartInit = function echartsLineRaceChartInit() {
  var Rs. lineRaceChartEl = document.querySelector('.echart-line-race-chart-example');

  if (Rs. lineRaceChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineRaceChartEl, 'options');
    var chart = window.echarts.init(Rs. lineRaceChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
...
var echartsLineShareDatasetChartInit = function echartsLineShareDatasetChartInit() {
  var Rs. lineShareChartEl = document.querySelector('.echart-line-share-dataset-chart-example');

  if (Rs. lineShareChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. lineShareChartEl, 'options');
    var chart = window.echarts.init(Rs. lineShareChartEl);
...
var echartsUsaMapInit = function echartsUsaMapInit() {
  var Rs. usaMapEl = document.querySelector('.echart-map-usa-example');
  var data = [{
    name: 'Alabama',
    value: 4822023
  }, {
  ...
  if (Rs. usaMapEl) {
    var userOptions = utils.getData(Rs. usaMapEl, 'options');
    var chart = window.echarts.init(Rs. usaMapEl);
...
var echartsNestedPiesChartInit = function echartsNestedPiesChartInit() {
  var Rs. echartsNestedPies = document.querySelector('.echarts-nested-pies-chart-example');

  if (Rs. echartsNestedPies) {
    var userOptions = utils.getData(Rs. echartsNestedPies, 'options');
    var chart = window.echarts.init(Rs. echartsNestedPies);
    ...
    var initChart = function initChart() {
      if (utils.isScrolledIntoView(Rs. echartsNestedPies)) {
        echartSetOption(chart, userOptions, getDefaultOptions);
...
var echartsPieChartInit = function echartsPieChartInit() {
  var Rs. pieChartEl = document.querySelector('.echart-pie-chart-example');

  if (Rs. pieChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. pieChartEl, 'options');
    var chart = window.echarts.init(Rs. pieChartEl);
...
var echartsPieEdgeAlignChartInit = function echartsPieEdgeAlignChartInit() {
  var Rs. echartPieAEdgeAlignChartEl = document.querySelector('.echart-pie-edge-align-chart');
  var data = [{
    value: 800,
    name: 'Starter',
    itemStyle: {
  ...
  if (Rs. echartPieAEdgeAlignChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. echartPieAEdgeAlignChartEl, 'options');
    var chart = window.echarts.init(Rs. echartPieAEdgeAlignChartEl);
...
var echartsPieLabelAlignChartInit = function echartsPieLabelAlignChartInit() {
  var Rs. echartPieLabelAlignChartEl = document.querySelector('.echart-pie-label-align-chart');

  if (Rs. echartPieLabelAlignChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. echartPieLabelAlignChartEl, 'options');
    var chart = window.echarts.init(Rs. echartPieLabelAlignChartEl);
    var data = [{
      value: 800,
      name: 'Starter',
      itemStyle: {
...
var echartsPieMultipleChartInit = function echartsPieMultipleChartInit() {
  var Rs. echartPieMultipleChartEl = document.querySelector('.echart-pie-multiple-chart');

  if (Rs. echartPieMultipleChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. echartPieMultipleChartEl, 'options');
    var chart = window.echarts.init(Rs. echartPieMultipleChartEl);
...
var echartsRadarChartInit = function echartsRadarChartInit() {
  var Rs. radarChartEl = document.querySelector('.echart-radar-chart-example');

  if (Rs. radarChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. radarChartEl, 'options');
    var chart = window.echarts.init(Rs. radarChartEl);
...
var echartsRadarCustomizedChartInit = function echartsRadarCustomizedChartInit() {
  var Rs. radarChartEl = document.querySelector('.echart-radar-customized-chart');
...
var echartsRadarMultipleChartInit = function echartsRadarMultipleChartInit() {
  var Rs. radarChartEl = document.querySelector('.echart-radar-multiple-chart');
...
var echartsScatterBasicChartInit = function echartsScatterBasicChartInit() {
  var Rs. basicScatterChartEl = document.querySelector('.echart-basic-scatter-chart-example');

  if (Rs. basicScatterChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. basicScatterChartEl, 'options');
    var chart = window.echarts.init(Rs. basicScatterChartEl);
...
var echartsScatterQuartetChartInit = function echartsScatterQuartetChartInit() {
  var Rs. scatterQuartetChartEl = document.querySelector('.echart-scatter-quartet-chart-example');

  if (Rs. scatterQuartetChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. scatterQuartetChartEl, 'options');
    var chart = window.echarts.init(Rs. scatterQuartetChartEl);
...
var echartsScatterSingleAxisChartInit = function echartsScatterSingleAxisChartInit() {
  var Rs. scatterSingleAxisChartEl = document.querySelector('.echart-scatter-single-axis-chart-example');

  if (Rs. scatterSingleAxisChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. scatterSingleAxisChartEl, 'options');
    var chart = window.echarts.init(Rs. scatterSingleAxisChartEl);
...
var echartsStackedAreaChartInit = function echartsStackedAreaChartInit() {
  var Rs. stackedAreaChartEl = document.querySelector('.echart-stacked-area-chart-example');

  if (Rs. stackedAreaChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. stackedAreaChartEl, 'options');
    var chart = window.echarts.init(Rs. stackedAreaChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
...
var echartsHorizontalStackedChartInit = function echartsHorizontalStackedChartInit() {
  var Rs. horizontalStackChartEl = document.querySelector('.echart-horizontal-stacked-chart-example');

  if (Rs. horizontalStackChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. horizontalStackChartEl, 'options');
    var chart = window.echarts.init(Rs. horizontalStackChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
...
var echartsStackedLineChartInit = function echartsStackedLineChartInit() {
  var Rs. stackedLineChartEl = document.querySelector('.echart-stacked-line-chart-example');

  if (Rs. stackedLineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. stackedLineChartEl, 'options');
    var chart = window.echarts.init(Rs. stackedLineChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
...
var echartsStackedVerticalChartInit = function echartsStackedVerticalChartInit() {
  var Rs. stackedVerticalChart = document.querySelector('.echart-stacked-vertival-chart-example');

  if (Rs. stackedVerticalChart) {
    var userOptions = utils.getData(Rs. stackedVerticalChart, 'options');
    var chart = window.echarts.init(Rs. stackedVerticalChart);
...
var echartsStepLineChartInit = function echartsStepLineChartInit() {
  var Rs. stepLineChartEl = document.querySelector('.echart-step-line-chart-example');

  if (Rs. stepLineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData(Rs. stepLineChartEl, 'options');
    var chart = window.echarts.init(Rs. stepLineChartEl);
    var days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
